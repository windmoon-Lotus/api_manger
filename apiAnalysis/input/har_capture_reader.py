...
class HarFlowWrapper:
    ...
    def get_url(self):
        exculd = ["js", "css", "ttf", "jpg", "svg", "gif", "jpeg", "png", "pdf", "rar", "svg", "ico",
                  "woff", "woff2", "otf", "zip", "docx", "html"]
        url = self.flow["request"]["url"].split("?")[0]
        if url.split('.')[-1] in exculd:
            return "None"
    ...
    def captured_requests(self) -> Iterator[HarFlowWrapper]:
        ...
        with open(self.file_path, "r", encoding="utf-8") as f:
            ...
            for entry in entries:
                ...
                #     print("idx:", "f.tell: ", f.tell())
                #     self.progress_callback(idx / len(entries))
