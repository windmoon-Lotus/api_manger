...
from apiAnalysis.conf.conf import timeout, proxies
from apiAnalysis.model import BasicModel
...
class HeaderModel(object):
    ...
    def __init__(self, header: dict, status_code: int = None, url: str = None, method: str = None, **kwargs):
        ...
        method = method.upper()
        assert method in [
            HeaderModel.METHOD_CONNECT,
            HeaderModel.METHOD_DELETE,
            HeaderModel.METHOD_GET,
            HeaderModel.METHOD_HEAD,
            HeaderModel.METHOD_OPTIONS,
            HeaderModel.METHOD_PATCH,
            HeaderModel.METHOD_POST,
            HeaderModel.METHOD_PUT,
            HeaderModel.METHOD_TRACE,
        ]
        self.url = url
        self.method = method
